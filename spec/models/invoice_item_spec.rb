...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe 'instance methods' do
    ...
    it 'discount method returns discount object that is eligible' do
      expect(@invoice_item1.discount).to eq(@disco1)
    end
    it "discount method prefers best discount percentage" do
      @disco2 = @merchant1.discounts.create!(percentage: 40, threshold: 5)
